    ...
    <div class="wrapper">
      ...
      <div class="timetable">
        <div style="display: flex; flex-direction: column; text-align:center;">
          <div
            style="height: 240px; width: 40px; padding: 10px; border: 1px solid #eeeeee90; box-sizing: border-box; writing-mode: vertical-rl; letter-spacing: 1.5em;"
          >上午</div>
          <div
            style="height: 240px; width: 40px; padding: 10px; border: 1px solid #eeeeee90; box-sizing: border-box; writing-mode: vertical-rl; letter-spacing: 1.5em;"
          >下午</div>
...
export default {
  ...
  computed:{
      coursetableData(){
          return this.$store.state.coursetable.myCourselist;
      }
  },
  mounted(){
      this.$store.dispatch("coursetable/getCoursetable")
  },
};
</script>
