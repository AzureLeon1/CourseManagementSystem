...
width="400px;">
    ...
    <div class="body" style="padding: 0 15px;">
        <el-form ref="form" :model="form" label-width="80px" label-position="left">
            ...
            <el-form-item prop="course_id" label="课程号">
            ...
            <el-form-item prop="sec_id" label="sec号">

        <el-select v-model="form.sec_id" placeholder="请选择sec号">
                <el-option
                ...
                <el-option
                    ...
                    <el-form-item prop="building" label="教室楼">
                ...
                <el-option
                 ...
                 <el-form-item prop="room" label="教室号" :rules="[
      { required: true, message: '教室号不能为空'},
                 ...
                 <!-- <el-form-item prop="teacher_name" label="教师姓名" :rules="[
      { required: true, message: '教师姓名不能为空'}
                 ...
                 <el-form-item prop="teacher_id" label="教师工号" :rules="[
      { required: true, message: '教师工号不能为空'},
        { type: 'number', message: '教师工号必须为数字值'}
                 ...
                 <el-form-item v-for="(domain, index) in form.domains" :label="'第' + String(index+1) +  '节课'"
                 :key="domain.key"
